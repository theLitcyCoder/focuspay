...
//       </select>
//       <input
//         className="w-full mb-3 p-2 border rounded placeholder-gray-400 dark:placeholder-gray-400"
//         type="number"
...
//           className="bg-blue-600 px-4 py-2 rounded text-gray-700 text-white hover:bg-blue-500 cursor-pointer"
//           >
//           ← Back to Dashboard
//         </button>
//       </div>
